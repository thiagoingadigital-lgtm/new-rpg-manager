...
function initDb() {
  ...
  readyPromise = (async () => {
    ...
    try { DB.run("ALTER TABLE characters ADD COLUMN creationData TEXT DEFAULT '{}'"); } catch (e) { /* coluna já existe */ }
    try { DB.run("ALTER TABLE characters ADD COLUMN subrace TEXT DEFAULT ''"); } catch (e) { /* coluna já existe */ }
